...
const ENEMIES_PER_ROW = 2; //enemigos por fila 
const ENEMY_HORIZONTAL_PADDING = 70; //posicion de los enemigos
...
function destroyEnemy($container, enemy) { //la destruccion del enemigo
...
function playerHasWon() {  //desaparece a los enemigos
