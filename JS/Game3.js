...
const ENEMIES_PER_ROW = 12; //enemigos por fila
...
const ENEMY_COOLDOWN = 8.0;//tiempo de disparo del enemigo

const GAME_STATE = { //Estado del juego, inicializamos 
  lastTime: Date.now(),
  leftPressed: false,
  rightPressed: false,
  escPressed: false,
...
function createEnemy($container, x, y) { //creacion del enemigo
  const $element = document.createElement("img");
  $element.src = "imagenes/Personajes/Enemigo3.gif";
